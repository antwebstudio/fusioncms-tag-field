(function(global2, factory) {
  ...
  window.Fusion.booting(function(Vue, router, store2) {
    Vue.component("tags-fieldtype", vue.defineAsyncComponent(() => Promise.resolve().then(() => Field$1)));
    const routes = [
      {
        path: "/tags",
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createElementVNode("label", {
        ...
        class: "form__label"
      }, vue.toDisplayString($props.field.name), 9, _hoisted_1$2),
      vue.createElementVNode("div", null, [
        vue.withDirectives(vue.createElementVNode("input", {
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.tag = $event),
          onKeyup: _cache[1] || (_cache[1] = vue.withKeys((...args) => $options.addTag && $options.addTag(...args), ["enter"])),
          type: "text",
          class: "w-100 form-control",
          placeholder: $options.placeholder
        }, null, 40, _hoisted_2$2), [
          [vue.vModelText, $data.tag]
        ])
      ]),
      vue.createElementVNode("div", null, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.tags, (tag, index) => {
  ...
  const Field = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-14aa721b"]]);
  ...
  const _hoisted_4$1 = /* @__PURE__ */ vue.createElementVNode("p", null, "Are you sure you want to permenantly delete this matrix?", -1);
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_app_title = vue.resolveComponent("app-title");
    const _component_portal = vue.resolveComponent("portal");
    const _component_router_link = vue.resolveComponent("router-link");
    const _component_ui_table = vue.resolveComponent("ui-table");
    const _component_ui_button = vue.resolveComponent("ui-button");
    const _component_ui_modal = vue.resolveComponent("ui-modal");
    const _directive_modal = vue.resolveDirective("modal");
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createVNode(_component_portal, { to: "title" }, {
        default: vue.withCtx(() => [
          vue.createVNode(_component_app_title, {
            icon: _ctx.layer - _ctx.group
          }, {
            default: vue.withCtx(() => [
              vue.createTextVNode("Tag")
            ], void 0, true),
            _: 1
          }, 8, ["icon"])
        ], void 0, true),
      ...
      vue.createElementVNode("div", _hoisted_1$1, [
        vue.createElementVNode("div", _hoisted_2$1, [
          vue.createVNode(_component_ui_table, {
            ...
            name: vue.withCtx((table) => [
              vue.createElementVNode("div", _hoisted_3$1, [
                vue.createVNode(_component_router_link, {
                  to: { name: "tag.edit", params: { id: table.record.id } }
                }, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(table.record.name), 1)
                  ], void 0, true),
                  _: 2
                }, 1032, ["to"])
              ])
            ]),
            slug: vue.withCtx((table) => [
              vue.createElementVNode("code", null, vue.toDisplayString(table.record.slug), 1)
            ]),
            _: 1
          }, 8, ["endpoint"])
        ])
      ]),
      vue.createVNode(_component_portal, { to: "modals" }, {
        default: vue.withCtx(() => [
          vue.createVNode(_component_ui_modal, {
            name: "delete-matrix",
            title: "Delete Matrix",
            key: "delete_matrix"
          }, {
            footer: vue.withCtx((matrix) => [
              vue.withDirectives((vue.openBlock(), vue.createBlock(_component_ui_button, {
              ...
              vue.withDirectives((vue.openBlock(), vue.createBlock(_component_ui_button, null, {
                default: vue.withCtx(() => [
  ...
  const filemanager = {
    ...
    actions: {
      ...
      fetchFilesAndDirectories: _$1.throttle(({ state, getters, commit, dispatch }) => {
      ...
      fetchFiles: _$1.throttle(({ state, getters, commit, dispatch }) => {
        commit("setLoading", true);
        let getDirectory = null;
        if (state.currentDirectory > 0)
          getDirectory = axios.get(`/api/directories/${state.disk.id}/${state.currentDirectory}`);
      ...
      fetchDirectories: _$1.throttle(({ state, getters, commit, dispatch }) => {
        commit("setLoading", true);
        let getDirectory = null;
        if (state.currentDirectory > 0)
          getDirectory = axios.get(`/api/directories/${state.disk.id}/${state.currentDirectory}`);
    ...
    computed: {
      sections() {
        ...
        if (this.extension.fieldset) {
          body = _.filter(this.extension.fieldset.sections, (section) => section.placement == "body");
          sidebar = _.filter(this.extension.fieldset.sections, (section) => section.placement == "sidebar");
        }
        return { body, sidebar };
      }
    }
  ...
  const _hoisted_4 = { class: "card__body" };
  const _hoisted_5 = {
    key: 1,
    class: "text-center"
  };
  const _hoisted_6 = /* @__PURE__ */ vue.createElementVNode("p", null, "Things are looking a little empty here!", -1);
  const _hoisted_7 = { class: "card" };
  const _hoisted_8 = { class: "card__body" };
  const _hoisted_9 = { class: "card__header" };
  const _hoisted_10 = { class: "card__title" };
  const _hoisted_11 = {
    key: 0,
    class: "card__subtitle"
  };
  const _hoisted_12 = { class: "card__body" };
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_router_link = vue.resolveComponent("router-link");
    const _component_portal = vue.resolveComponent("portal");
    const _component_ui_title = vue.resolveComponent("ui-title");
    const _component_ui_tab = vue.resolveComponent("ui-tab");
    const _component_ui_tabs = vue.resolveComponent("ui-tabs");
    const _component_ui_slug = vue.resolveComponent("ui-slug");
    const _component_fa_icon = vue.resolveComponent("fa-icon");
    const _component_ui_definition = vue.resolveComponent("ui-definition");
    const _component_ui_definition_list = vue.resolveComponent("ui-definition-list");
    const _component_form_container = vue.resolveComponent("form-container");
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createVNode(_component_form_container, null, {
        default: vue.withCtx(() => [
          vue.createVNode(_component_portal, { to: "actions" }, {
            default: vue.withCtx(() => [
              vue.createElementVNode("div", _hoisted_1, [
                $props.extension.slug ? (vue.openBlock(), vue.createBlock(_component_router_link, {
                  key: 0,
                  to: { name: "extension.index", params: { extension: $props.extension.slug } },
                ...
                vue.createElementVNode("button", {
                  type: "submit",
                  onClick: _cache[0] || (_cache[0] = vue.withModifiers((...args) => _ctx.$parent.submit && _ctx.$parent.submit(...args), ["prevent"])),
                  class: vue.normalizeClass(["button button--primary", { "button--disabled": !$props.form.hasChanges }]),
                  disabled: !$props.form.hasChanges
                }, "Save", 10, _hoisted_2)
              ])
            ], void 0, true),
            _: 1
          ...
          vue.createElementVNode("div", _hoisted_3, [
            vue.createElementVNode("div", _hoisted_4, [
              vue.createVNode(_component_ui_title, {
                name: "name",
                label: $props.extension.name_label || "Name",
                autocomplete: "off",
                autofocus: "",
                required: "",
                placeholder: $props.extension.name_label || "Name",
                "has-error": $props.form.errors.has("name"),
                "error-message": $props.form.errors.get("name"),
                modelValue: $props.form.name,
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $props.form.name = $event)
              }, null, 8, ["label", "placeholder", "has-error", "error-message", "modelValue"]),
              $options.sections.body.length > 0 ? (vue.openBlock(), vue.createBlock(_component_ui_tabs, { key: 0 }, {
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.sections.body, (section) => {
                    return vue.openBlock(), vue.createBlock(_component_ui_tab, {
                      key: section.handle,
                      name: section.name
                    }, {
                      default: vue.withCtx(() => [
                        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(section.fields, (field) => {
                          return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(field.type.id + "-fieldtype"), {
                            class: "form__group",
                            key: field.handle,
                            field,
                            errors: $props.form.errors,
                            modelValue: $props.form[field.handle],
                            "onUpdate:modelValue": ($event) => $props.form[field.handle] = $event
                          }, null, 8, ["field", "errors", "modelValue", "onUpdate:modelValue"]);
                        }), 128))
                      ], void 0, true),
                      _: 2
                    }, 1032, ["name"]);
                ...
                vue.createVNode(_component_router_link, {
                  class: "button",
                  to: "/extensions/" + $props.extension.id + "/edit"
                }, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode("Configure your extension")
                  ], void 0, true),
                  _: 1
                }, 8, ["to"])
              ]))
          ...
          vue.createVNode(_component_portal, { to: "sidebar-right" }, {
            default: vue.withCtx(() => [
              vue.createElementVNode("div", null, [
                vue.createElementVNode("div", _hoisted_7, [
                  vue.createElementVNode("div", _hoisted_8, [
                    $props.extension.show_name_field || $props.entry.id ? (vue.openBlock(), vue.createBlock(_component_ui_slug, {
                      key: 0,
                      name: "slug",
                      label: "Slug",
                      monospaced: "",
                      autocomplete: "off",
                      required: "",
                      help: $props.extension.show_name_field ? "" : "This field is auto-generated based on pattern specified.",
                      watch: $props.form.name,
                      readonly: !$props.extension.show_name_field,
                      "has-error": $props.form.errors.has("slug"),
                      "error-message": $props.form.errors.get("slug"),
                      modelValue: $props.form.slug,
                      "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $props.form.slug = $event)
                    }, null, 8, ["help", "watch", "readonly", "has-error", "error-message", "modelValue"])) : vue.createCommentVNode("", true)
                  ])
                ]),
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.sections.sidebar, (section) => {
                  return vue.openBlock(), vue.createElementBlock("div", {
                    class: "card",
                    key: section.handle
                  }, [
                    vue.createElementVNode("div", _hoisted_9, [
                      vue.createElementVNode("h3", _hoisted_10, vue.toDisplayString(section.name), 1),
                      section.description ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_11, vue.toDisplayString(section.description), 1)) : vue.createCommentVNode("", true)
                    ]),
                    vue.createElementVNode("div", _hoisted_12, [
                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(section.fields, (field) => {
                        return vue.openBlock(), vue.createElementBlock("div", null, [
                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(section.fields, (field2) => {
                            return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(field2.type.id + "-fieldtype"), {
                              key: field2.handle,
                              field: field2,
                              "has-error": $props.form.errors.has(field2.handle),
                              "error-message": $props.form.errors.get(field2.handle),
                              modelValue: $props.form[field2.handle],
                              "onUpdate:modelValue": ($event) => $props.form[field2.handle] = $event
                            }, null, 8, ["field", "has-error", "error-message", "modelValue", "onUpdate:modelValue"]);
                          }), 128))
                        ]);
                      }), 256))
                    ])
                ...
                $props.entry ? (vue.openBlock(), vue.createBlock(_component_ui_definition_list, { key: 0 }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_ui_definition, { name: "Status" }, {
                      default: vue.withCtx(() => [
                        vue.createVNode(_component_fa_icon, {
                          icon: ["fas", "circle"],
                          class: vue.normalizeClass(["fa-fw text-xs", { "text-success-500": $props.entry.status, "text-danger-500": !$props.entry.status }])
                        }, null, 8, ["class"]),
                        vue.createTextVNode(" " + vue.toDisplayString($props.entry.status ? "Enabled" : "Disabled"), 1)
                      ], void 0, true),
                      _: 1
                    }),
                    vue.createVNode(_component_ui_definition, { name: "Created At" }, {
                      default: vue.withCtx(() => [
                        vue.createTextVNode(vue.toDisplayString(_ctx.$moment($props.entry.created_at).format("Y-MM-DD, hh:mm a")), 1)
                      ], void 0, true),
                      _: 1
                    }),
                    vue.createVNode(_component_ui_definition, { name: "Updated At" }, {
                      default: vue.withCtx(() => [
                        vue.createTextVNode(vue.toDisplayString(_ctx.$moment($props.entry.updated_at).format("Y-MM-DD, hh:mm a")), 1)
                      ], void 0, true),
                      _: 1
                    })
                  ], void 0, true),
  ...
  const SharedForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
  const _sfc_main = {
    head: {
      title() {
        return {
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_page_title = vue.resolveComponent("page-title");
    const _component_portal = vue.resolveComponent("portal");
    const _component_shared_form = vue.resolveComponent("shared-form");
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createVNode(_component_portal, { to: "title" }, {
        default: vue.withCtx(() => [
          vue.createVNode(_component_page_title, { icon: "pencil-alt" }, {
            default: vue.withCtx(() => [
              vue.createTextVNode("Edit " + vue.toDisplayString($data.entry.name), 1)
            ], void 0, true),
            _: 1
          })
        ], void 0, true),
      ...
      $data.form ? (vue.openBlock(), vue.createBlock(_component_shared_form, {
        key: 0,
        form: $data.form,
        entry: $data.entry,
        extension: $data.extension
      }, null, 8, ["form", "entry", "extension"])) : vue.createCommentVNode("", true)
    ]);
  }
