import { watch, effectScope, reactive, computed, resolveComponent, openBlock, createElementBlock, createVNode, withCtx, createElementVNode, createBlock, createTextVNode, createCommentVNode, withModifiers, normalizeClass, Fragment, renderList, resolveDynamicComponent, toDisplayString } from "vue";
...
const _hoisted_6 = /* @__PURE__ */ createElementVNode("p", null, "Things are looking a little empty here!", -1);
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_ui_slug = resolveComponent("ui-slug");
  const _component_fa_icon = resolveComponent("fa-icon");
  const _component_ui_definition = resolveComponent("ui-definition");
  const _component_ui_definition_list = resolveComponent("ui-definition-list");
  const _component_form_container = resolveComponent("form-container");
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_form_container, null, {
      default: withCtx(() => [
        createVNode(_component_portal, { to: "actions" }, {
          default: withCtx(() => [
            createElementVNode("div", _hoisted_1, [
              $props.extension.slug ? (openBlock(), createBlock(_component_router_link, {
                key: 0,
              ...
              createElementVNode("button", {
                type: "submit",
                onClick: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.$parent.submit && _ctx.$parent.submit(...args), ["prevent"])),
                class: normalizeClass(["button button--primary", { "button--disabled": !$props.form.hasChanges }]),
        ...
        createElementVNode("div", _hoisted_3, [
          createElementVNode("div", _hoisted_4, [
            createVNode(_component_ui_title, {
              name: "name",
            ...
            $options.sections.body.length > 0 ? (openBlock(), createBlock(_component_ui_tabs, { key: 0 }, {
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList($options.sections.body, (section) => {
                  return openBlock(), createBlock(_component_ui_tab, {
                    ...
                    default: withCtx(() => [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(section.fields, (field) => {
                        return openBlock(), createBlock(resolveDynamicComponent(field.type.id + "-fieldtype"), {
                          class: "form__group",
                          key: field.handle,
                          field,
              ...
              createVNode(_component_router_link, {
                ...
                default: withCtx(() => [
                  createTextVNode("Configure your extension")
                ], void 0, true),
                _: 1
              }, 8, ["to"])
            ]))
            ...
            createElementVNode("div", null, [
              createElementVNode("div", _hoisted_7, [
                createElementVNode("div", _hoisted_8, [
                  $props.extension.show_name_field || $props.entry.id ? (openBlock(), createBlock(_component_ui_slug, {
                    key: 0,
                    name: "slug",
                    label: "Slug",
                    monospaced: "",
                  ...
                  }, null, 8, ["help", "watch", "readonly", "has-error", "error-message", "modelValue"])) : createCommentVNode("", true)
                ])
              ]),
              (openBlock(true), createElementBlock(Fragment, null, renderList($options.sections.sidebar, (section) => {
                return openBlock(), createElementBlock("div", {
                  class: "card",
                  key: section.handle
                }, [
                  createElementVNode("div", _hoisted_9, [
                    createElementVNode("h3", _hoisted_10, toDisplayString(section.name), 1),
                    section.description ? (openBlock(), createElementBlock("p", _hoisted_11, toDisplayString(section.description), 1)) : createCommentVNode("", true)
                  ]),
                  createElementVNode("div", _hoisted_12, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(section.fields, (field) => {
                      return openBlock(), createElementBlock("div", null, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(section.fields, (field2) => {
                          return openBlock(), createBlock(resolveDynamicComponent(field2.type.id + "-fieldtype"), {
                            key: field2.handle,
                            field: field2,
              ...
              $props.entry ? (openBlock(), createBlock(_component_ui_definition_list, { key: 0 }, {
                default: withCtx(() => [
                  createVNode(_component_ui_definition, { name: "Status" }, {
                    default: withCtx(() => [
                      createVNode(_component_fa_icon, {
                        icon: ["fas", "circle"],
                        class: normalizeClass(["fa-fw text-xs", { "text-success-500": $props.entry.status, "text-danger-500": !$props.entry.status }])
                      }, null, 8, ["class"]),
                      createTextVNode(" " + toDisplayString($props.entry.status ? "Enabled" : "Disabled"), 1)
                    ], void 0, true),
                    _: 1
                  }),
                  createVNode(_component_ui_definition, { name: "Created At" }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(_ctx.$moment($props.entry.created_at).format("Y-MM-DD, hh:mm a")), 1)
                    ], void 0, true),
                    _: 1
                  }),
                  createVNode(_component_ui_definition, { name: "Updated At" }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(_ctx.$moment($props.entry.updated_at).format("Y-MM-DD, hh:mm a")), 1)
                    ], void 0, true),
                    _: 1
                  })
                ], void 0, true),
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_portal, { to: "title" }, {
      default: withCtx(() => [
        createVNode(_component_page_title, { icon: "pencil-alt" }, {
          default: withCtx(() => [
            createTextVNode("Edit " + toDisplayString($data.entry.name), 1)
          ], void 0, true),
          _: 1
        })
      ], void 0, true),
    ...
    }, null, 8, ["form", "entry", "extension"])) : createCommentVNode("", true)
  ]);
}
